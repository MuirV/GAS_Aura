...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
   ...
   FString("Abilities Attack Tag")
    ...
    GameplayTags.Montage_Combat_Weapon = UGameplayTagsManager::Get().AddNativeGameplayTag(
   FName("Montage.Combat.Weapon"),
   FString("Montage Combat Weapon")
   );

    GameplayTags.Montage_Combat_LeftHand = UGameplayTagsManager::Get().AddNativeGameplayTag(
   FName("Montage.Combat.LeftHand"),
   FString("Left Hand")
   );

    GameplayTags.Montage_Combat_RightHand = UGameplayTagsManager::Get().AddNativeGameplayTag(
   FName("Montage.Combat.RightHand"),
   FString("Right Hand")
   );
